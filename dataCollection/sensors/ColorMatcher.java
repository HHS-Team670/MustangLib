...
public class ColorMatcher {
  ...
  private final String COLORMATCHER_RED, COLORMATCHER_GREEN, COLORMATCHER_BLUE,
      COLORMATCHER_CONFIDENCE;
  ...
  public int detectColor() {
    ...
    ColorMatchResult match = m_colorMatcher
        .matchClosestColor(new Color(detectedColor.red, detectedColor.green, detectedColor.blue));
