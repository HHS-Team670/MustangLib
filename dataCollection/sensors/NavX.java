...
public class NavX {
  ...
  /**
   * Resets and recalibrates the NavX (yaw will go back to zero and offset cleared). Call this right
  ...
  /**
   * Resets the values of mLastSensorTimestampMs, mYawDegrees, and mYawRateDegreesPerSecond to their
   * initial values.
   */
