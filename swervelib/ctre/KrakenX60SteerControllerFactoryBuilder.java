...
public final class KrakenX60SteerControllerFactoryBuilder {
    ...
    public KrakenX60SteerControllerFactoryBuilder withPidConstants(double proportional, double integral, double derivative) {
    ...
    public KrakenX60SteerControllerFactoryBuilder withMotionMagic(double velocityConstant, double accelerationConstant, double staticConstant) {
    ...
    public KrakenX60SteerControllerFactoryBuilder withVoltageCompensation(double nominalVoltage) {
    ...
    public KrakenX60SteerControllerFactoryBuilder withCurrentLimit(double currentLimit) {
    ...
    private class FactoryImplementation<T> implements SteerControllerFactory<ControllerImplementation, SteerConfiguration<T>> {
        ...
        public ControllerImplementation create(SteerConfiguration<T> steerConfiguration, String canbus, ModuleConfiguration moduleConfiguration) {
            ...
            // checkCtreError(motor.configAllSettings(motorConfiguration, CAN_TIMEOUT_MS), "Failed to configure Falcon 500 settings"); // DROPPED FROM API
