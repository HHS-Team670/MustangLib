...
public final class Mk4iSwerveModuleHelper {
        ...
        private static SteerControllerFactory<?, SteerConfiguration<CanandCoderAbsoluteConfiguration>> getNeoHeliumSteerFactory(
                ...
                return new NeoSteerControllerFactoryBuilder()
                                ...
                                .build(new HeliumCanCoderFactoryBuilder()
                                                .withReadingUpdatePeriod(100).build());
        }
                        ...
                        return new SwerveModuleFactory<>(gearRatio.getConfiguration(),
                                        ...
                                        getNeoHeliumSteerFactory(configuration)).create(
                                                        ...
                                                        new SteerConfiguration<>(steerMotorPort,
                                                                        new CanandCoderAbsoluteConfiguration(
                                                                                        steerEncoderPort)));
                }
                return new SwerveModuleFactory<>(gearRatio.getConfiguration(),
                                getNeoDriveFactory(configuration),
                                getNeoCanCoderSteerFactory(configuration)).create(
                                                driveMotorPort,
                                                new SteerConfiguration<>(steerMotorPort,
        ...
        public static SwerveModule createKrakenX60Neo(ShuffleboardLayout container,
                ...
                return createKrakenX60Neo(container, new Mk4ModuleConfiguration(), gearRatio,
        ...
        public enum GearRatio {
                L1(SdsModuleConfigurations.MK4I_L1), L2(SdsModuleConfigurations.MK4I_L2), L2K(
                                SdsModuleConfigurations.MK4I_L2K), L3(
