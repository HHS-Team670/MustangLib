...
public final class Mk4SwerveModuleHelper {
        ...
        private static SteerControllerFactory<?, SteerConfiguration<CanCoderAbsoluteConfiguration>> getNeoSteerFactory(
                ...
                return new NeoSteerControllerFactoryBuilder()
                                .withVoltageCompensation(configuration.getNominalVoltage())
                                .withPidConstants(configuration.getSteerKP(),
        ...
        public static SwerveModule createNeo(GearRatio gearRatio, int driveMotorPort,
                ...
                return createNeo(Mk4ModuleConfiguration.getDefaultSteerNEO(), gearRatio,
                                driveMotorPort, steerMotorPort, steerEncoderPort, steerOffset);
        }
        ...
        public static SwerveModule createKrakenX60Neo(ShuffleboardLayout container,
                        Mk4ModuleConfiguration configuration, GearRatio gearRatio,
                        int driveMotorPort, String driveCanbus, int steerMotorPort,
                        int steerEncoderPort

        ) {
                return new SwerveModuleFactory<>(gearRatio.getConfiguration(),
                                getKrakenX60DriveFactory(configuration),
                                getNeoSteerFactory(configuration)).create(container, driveMotorPort,
                                                driveCanbus,
                                                new SteerConfiguration<>(steerMotorPort,
                                                                new CanCoderAbsoluteConfiguration(
                                                                                steerEncoderPort)),
         ...
         */
        public static SwerveModule createKrakenX60Neo(ShuffleboardLayout container,
                        GearRatio gearRatio, int driveMotorPort, String driveCanbus,
                        int steerMotorPort, int steerEncoderPort) {
                return createKrakenX60Neo(container, Mk4ModuleConfiguration.getDefaultSteerNEO(),
                                gearRatio, driveMotorPort, driveCanbus, steerMotorPort,
                                steerEncoderPort);
        }
        ...
        public static SwerveModule createKrakenX60Neo(ShuffleboardLayout container,
                        ...
                        int steerEncoderPort) {
                return createKrakenX60Neo(container, Mk4ModuleConfiguration.getDefaultSteerNEO(),
                                gearRatio, driveMotorPort, steerMotorPort, steerEncoderPort);
        }
        ...
        public static SwerveModule createKrakenX60Neo(Mk4ModuleConfiguration configuration,
                ...
                return new SwerveModuleFactory<>(gearRatio.getConfiguration(),
                                getKrakenX60DriveFactory(configuration),
                                getNeoSteerFactory(configuration)).create(driveMotorPort,
                                                driveCanbus,
                                                new SteerConfiguration<>(steerMotorPort,
                                                                new CanCoderAbsoluteConfiguration(
                                                                                steerEncoderPort)),
