...
public interface SteerControllerFactory<Controller extends SteerController, SC> {
    ...
    default Controller create(ShuffleboardContainer dashboardContainer, SC steerConfiguration,
            String canbus, ModuleConfiguration moduleConfiguration) {
    ...
    default Controller create(SC steerConfiguration, ModuleConfiguration moduleConfiguration) {
        return create(steerConfiguration, "", moduleConfiguration);
    }

    Controller create(SC steerConfiguration, String canbus,
            ModuleConfiguration moduleConfiguration);
}
