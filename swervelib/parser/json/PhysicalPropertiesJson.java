...
public class PhysicalPropertiesJson {
  ...
  /**
   * Gear ratio for the motors, number of times the motor has to spin before the
   * wheel rotates a single time.
   */
  public MotorConfigDouble gearRatio;
  /**
   * Encoder pulse per rotation for non-integrated encoders. 1 for integrated
   * encoders.
   */
   ...
   * you translate. Default value is 0. If
   * robot arcs while translating and rotating negate this.
   */
  public double moduleFeedForwardClosedLoop = -0.33;
  /**
   * DEPRECATED: No longer needed, tune
   * {@link PhysicalPropertiesJson#moduleFeedForwardClosedLoop} instead.
   */
   ...
   *
   * @param optimalVoltage Optimal voltage to compensate for and use to calculate
