...
import frc.team670.mustanglib.swervelib.imu.SwerveIMU;
import frc.team670.mustanglib.swervelib.math.SwerveKinematics2;
import frc.team670.mustanglib.swervelib.math.SwerveMath;
import frc.team670.mustanglib.swervelib.math.SwerveModuleState2;
import frc.team670.mustanglib.swervelib.math.SwervePoseEstimator2;
...
// import frc.team670.mustanglib.swervelib.telemetry.SwerveDriveTelemetry;
// import frc.team670.mustanglib.swervelib.telemetry.SwerveDriveTelemetry.TelemetryVerbosity;

/**
 * Swerve Drive class representing and controlling the swerve drive.
 */
public class SwerveDrive extends MustangSubsystemBase {
  ...
  public SwerveDrive(
    ...
    // if (SwerveDriveTelemetry.verbosity.ordinal() >=
    // TelemetryVerbosity.LOW.ordinal())
    // {
    // SmartDashboard.putData("Field", field);
    // }

    // if (SwerveDriveTelemetry.verbosity.ordinal() >=
    // TelemetryVerbosity.HIGH.ordinal())
    // {
    ...
    // Units.metersToInches(SwerveMath.getSwerveModule(swerveModules, true,
    // false).moduleLocation.getX() +
    // SwerveMath.getSwerveModule(swerveModules,
    // false,
    // false).moduleLocation.getX());
    // SwerveDriveTelemetry.sizeLeftRight =
    // Units.metersToInches(SwerveMath.getSwerveModule(swerveModules, false,
    // true).moduleLocation.getY() +
    // SwerveMath.getSwerveModule(swerveModules,
    // false,
    // false).moduleLocation.getY());
    // SwerveDriveTelemetry.wheelLocations = new
    // double[SwerveDriveTelemetry.moduleCount * 2];
    ...
    // }
    // SwerveDriveTelemetry.measuredStates = new
    // double[SwerveDriveTelemetry.moduleCount * 2];
    // SwerveDriveTelemetry.desiredStates = new
    // double[SwerveDriveTelemetry.moduleCount * 2];
    // }
  }
  ...
  public void setChassisSpeeds(ChassisSpeeds chassisSpeeds) {
    // SwerveDriveTelemetry.desiredChassisSpeeds[1] =
   ...
   * {@link SwerveDrive#setRawModuleStates(SwerveModuleState2[], boolean)}
   * function and
  ...
  public void lockPose() {
    // Sets states
    for (SwerveModule swerveModule : swerveModules) {
      SwerveModuleState2 desiredState = new SwerveModuleState2(0, swerveModule.configuration.moduleLocation.getAngle(),
          0);
      // if (SwerveDriveTelemetry.verbosity.ordinal() >=
      // TelemetryVerbosity.HIGH.ordinal())
      // {
  ...
  public SwerveKinematics2 getSwerveKinematics() {
    return kinematics;
  }

  public Rotation2d getGyroscopicRotation() {
    return swerveDrivePoseEstimator.getOdometry().getGyroOffset();
  }
