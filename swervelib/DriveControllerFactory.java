...
public interface DriveControllerFactory<Controller extends DriveController, DriveConfiguration> {
  ...
  default Controller create(ShuffleboardContainer container, DriveConfiguration driveConfiguration,
  ...
  default Controller create(DriveConfiguration driveConfiguration,
      ModuleConfiguration moduleConfiguration) {
    return create(driveConfiguration, "", moduleConfiguration);
  }

  Controller create(DriveConfiguration driveConfiguration, String canbus,
      ModuleConfiguration moduleConfiguration);
}
