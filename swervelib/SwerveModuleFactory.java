...
public class SwerveModuleFactory<DC, SC> {
  ...
  public SwerveModule create(ShuffleboardLayout container, DC driveConfiguration,
    ...
    var driveController = driveControllerFactory.create(container, driveConfiguration, driveCanbus,
        moduleConfiguration);
    var steerContainer = steerControllerFactory.create(container, steerConfiguration, steerCanbus,
        moduleConfiguration);
