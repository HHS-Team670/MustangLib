...
public interface MustangCommand {
  ...
  /**
   * @return A Map containing the minimum health condition for each subsystem that this Command
   *         requires to be safely used.
   */
  public Map<MustangSubsystemBase, MustangSubsystemBase.HealthState> getHealthRequirements();

  /**
   * logs data revelant to debugging this command For use when execute or other parts of command
   * have logical errors
   */
