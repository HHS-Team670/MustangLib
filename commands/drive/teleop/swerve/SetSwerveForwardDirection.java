 ...
 * MustangScheduler as a part of MustangLib implementations in FRC code from Team 670 is used to set
 * the forward on a swerve drive that utilizes SDS swerve modules with two Neo motors. It does this
 * by zeroing the heading on the gyroscope on the robot and then realigning the modules to the
 * current heading so that the new fforward direction is the same as the current direction.
 */
