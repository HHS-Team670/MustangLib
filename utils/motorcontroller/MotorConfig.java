...
public class MotorConfig {
    ...
    public static final Map<Motor_Type, Integer> MOTOR_MAX_CURRENT =
            new HashMap<Motor_Type, Integer>() {
                {
                    ...
                    put(Motor_Type.KRAKEN_X60, 40);
                }
            };

    public static final Map<Motor_Type, MotorType> MOTOR_TYPE =
            new HashMap<Motor_Type, MotorType>() {
                {
