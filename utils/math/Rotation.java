...
public class Rotation {
	 ...
	 * @param normalize whether or not we should "normalize" this rotation
	 *                  {@link #normalize()}
	 */
	...
	/**
	 * Create a rotation matrix from a translation vector. This basically is the
	 * angle from the positive x axis to the translation vector.
	 *
	 * @param directionVector the translation vector to calculate the angle from
	 */
	public Rotation(Translation2d directionVector) {
