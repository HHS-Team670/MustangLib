...
package frc.team670.mustanglib.utils.functions;
...
public class MathUtils {
  ...
  // This private constructor makes it so no version of this Object can be instantiated, as we
  // only want it for static functions
  private MathUtils() {}

  /**
   * Compares two doubles for equality, returning true if they are equal. Use this since in Java
   * using '==' does not work to compare doubles.
   */
   ...
   * @param d1
   * @param d2
   * @param comparator The value used to compare the doubles after subtracting (ex. 0.0000001). If
   *        working with especially small numbers, you would want to set this very low since the
   *        difference between them may just be small and not an issue with double comparation.
   */
