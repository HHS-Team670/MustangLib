...
public class ConsoleLogger {
  ...
  public static class CustomLogger {
    ...
    public static void setup() throws IOException {
      ...
      Date date = new Date();
      fileTxt = new FileHandler(String.format("/home/lvuser/Log_%s_%s_%s.txt",
          DriverStation.getEventName(), DriverStation.getMatchNumber(), dateFormat.format(date)));
   ...
   *        formatting. It makes the parameters appear in the String where the '%s' are in order of
   *        input.
  ...
  public static void consoleLog(String message, Object... parameters) {
    ...
    LOGGER.log(Level.INFO, String.format("robot: MatchTime:%s: %s: %s",
        DriverStation.getMatchTime(), currentMethod(2), String.format(message, parameters)));
  }
  ...
  public static void consoleError(String message, Object... parameters) {
    // logs to the console as well as our log file on RR disk.
    LOGGER.log(Level.SEVERE, String.format("robot: MatchTime:%s: %s: %s",
        DriverStation.getMatchTime(), currentMethod(2), String.format(message, parameters)));
  }
  ...
  public static void consoleWarning(String message, Object... parameters) {
    // logs to the console as well as our log file on RR disk.
    LOGGER.log(Level.WARNING, String.format("robot: MatchTime:%s: %s: %s",
        DriverStation.getMatchTime(), currentMethod(2), String.format(message, parameters)));
  }
