...
public abstract class TankDrive extends DriveBase {
     ...
     *                          etc.
     */
    public TankDrive(MotorController leftMotor, MotorController rightMotor, boolean inverted,
            boolean rightSideInverted, double deadband, boolean safetyEnabled) {
        setMotorControllers(leftMotor, rightMotor, inverted, rightSideInverted, deadband, safetyEnabled);
    ...
    public TankDrive(MotorController leftMotor, MotorController rightMotor) {
        this(leftMotor, rightMotor, true, true, 0.02, true);
    }
    ...
    public TankDrive(MotorController leftMotor, MotorController rightMotor, boolean inverted,
        ...
        this(leftMotor, rightMotor, inverted, rightSideInverted, 0.02, true);
    }

    /**
     * Use this constructor as the super() in a subclass, then call
     * setMotorControllers if you need to run setup on Motor Controllers
     */
    public TankDrive() {
    }
