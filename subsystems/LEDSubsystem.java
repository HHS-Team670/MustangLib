...
public abstract class LEDSubsystem extends MustangSubsystemBase {
   ...
   *        the rainbow effect. It determines the color of the first pixel in the rainbow sequence.
   */
   ...
   * @param updateSpeed The updateSpeed parameter determines how often the rainbow animation should
   *        be updated. It represents the number of iterations before the animation is updated.
   * @param rainbowSpeed The `rainbowSpeed` parameter determines how quickly the colors of the
   *        rainbow change. A higher value will result in a faster movement of the rainbow animation
   *        while a lower value will result in a slower movement of the rainbow animation.
   */
   ...
   *        initial saturation value for the Mustang Rainbow effect. It determines the starting
   *        saturation level for the colors in the rainbow effect.
   */
  ...
  public void solidMustangRainbow(int mustangRainbowFirstSaturation) {
    ...
    for (var i = startIndex; i < m_ledBuffer.getLength(); i++) {
      m_ledBuffer.setHSV(i, 60,
          m_mustangRainbowFirstSaturation + (i * 255 / m_ledBuffer.getLength()) % 255, 255);
    }
    // Check bounds
