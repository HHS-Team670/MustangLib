 ...
 */
public abstract class LEDSubsystem2 extends MustangSubsystemBase {
    /**
     ...
     */
    public LEDSubsystem2(int port, int length) {
        this(port, 0, length);
    }

    public LEDSubsystem2(int port, int startIndex, int endIndex) {
