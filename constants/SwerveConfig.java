...
public class SwerveConfig {
    ...
    public SwerveConfig(double driveBaseTrackWidth, double driveBaseWheelBase, double maxVelocity, double maxVoltage,
                        SerialPort.Port navXPort,
                        int frontLeftModuleDriveMotor, int frontLeftModuleSteerMotor, int frontLeftModuleSteerEncoder, double frontLeftModuleSteerOffset, 
                        int frontRightModuleDriveMotor, int frontRightModuleSteerMotor, int frontRightModuleSteerEncoder, double frontRightModuleSteerOffset,
                        int backLeftModuleDriveMotor, int backLeftModuleSteerMotor, int backLeftModuleSteerEncoder, double backLeftModuleSteerOffset,
                        int backRightModuleDriveMotor, int backRightModuleSteerMotor, int backRightModuleSteerEncoder, double backRightModuleSteerOffset) {
