...
public class XboxRocketLeagueDrive extends InstantCommand {
  ...
  protected void initialize() {
    ...
    double speed = -1
        * (Robot.oi.getDriverController().getLeftTriggerAxis() - Robot.oi.getDriverController().getRightTriggerAxis());
  ...
  /**
   * Determines wheter the drive is revers
   * 
   * @return true if drive is reversed
   */
  ...
  /**
   * Sets the drive into reverse
   * 
   * @param reversed if drive is reversed or not
   */
