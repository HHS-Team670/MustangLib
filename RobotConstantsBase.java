...
/**
 * A place for storing constants required in mustanglib. This includes most drivebase constants. For
 * every robot, add mac address like below as well as relevant constants
 * 
 * Update every year
 */
public class RobotConstantsBase {
    ...
    public static class SwerveDriveBase {
        ...
        public static final double kMaxAngularSpeedRadiansPerSecond = Math.PI * 8;// What if we turn
                                                                                  // this up? //Not
                                                                                  // robot specific
        public static final double kMaxAngularAccelerationRadiansPerSecondSquared = Math.PI * 16;// Not
                                                                                                 // robot
                                                                                                 // specific
        ...
        public static final int kCurrentSampleSize = (int) (kCurrentSampleTimeRange * 50); // mustangPeriodic
                                                                                           // runs
                                                                                           // 50hz
